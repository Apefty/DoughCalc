...
DoughCalc.routes = {
  ...
  'bread/mixed-flour-miche': {
    ...
    init: function (data) {
      DoughCalc.initRecipePage(data, {
        flourTypes: [
          { name: 'Type 80 борошно', pct: 70 },
          { name: 'Ціложитнє борошно', pct: 15 },
          { name: 'Гречане борошно', pct: 15 }
        ]
      });
    }
  },
    ...
    init: function (data) {
      DoughCalc.initRecipePage(data, {
        flourTypes: [
          ...
          { name: 'Хлібне борошно (clear flour)', pct: 85 }
        ]
      });
    }
  },
